...
from starletteapi.compatible import EmailStr
...
class Operation(BaseModel):
    ...
    callbacks: t.Optional[t.Dict[str, t.Union[t.Dict[str, "PathItem"], Reference]]] = None
    deprecated: t.Optional[bool] = None
...
class Components(BaseModel):
    ...
    callbacks: t.Optional[t.Dict[str, t.Union[t.Dict[str, PathItem], Reference, t.Any]]] = None
