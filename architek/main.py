...
from architek.conf import Config
from architek.datastructures import State, URLPath
from architek.di import StarletteInjector
from architek.events import ApplicationEventManager, RouterEventManager
from architek.guard import GuardCanActivate
from architek.logger import logger
from architek.middleware import (
    ExceptionMiddleware,
    Middleware,
...
from architek.module import ApplicationModule, BaseModule, StarletteAPIModuleBase
from architek.routing import AppRouter, AppRoutes, BaseRoute
from architek.templating import Environment, StarletteAppTemplating
from architek.types import ASGIApp, T, TReceive, TScope, TSend


class ArchitekApp(StarletteAppTemplating):
    def __init__(self, module: t.Optional[ApplicationModule] = None):
        if module:
            assert isinstance(
    ...
    def install_module(
        self,
        module: t.Union[t.Type[T], t.Type[StarletteAPIModuleBase], BaseModule],
        **init_kwargs: t.Any,
    ) -> t.Union[T, StarletteAPIModuleBase, BaseModule]:
