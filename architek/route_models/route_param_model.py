...
if t.TYPE_CHECKING:
    from architek.routing.operations import ExtraOperationArg
...
class EndpointParameterModel:
    ...
    def __deepcopy__(self, memodict: t.Dict = {}) -> "EndpointParameterModel":
        return self.__copy__(memodict)

    def __copy__(self, memodict: t.Dict = {}) -> "EndpointParameterModel":
        return self
