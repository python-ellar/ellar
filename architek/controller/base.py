...
def get_route_functions(cls: t.Type) -> t.Iterable["OperationDecorator"]:
    from architek.routing.operations import OperationDecorator

    for method in cls.__dict__.values():
        if isinstance(method, OperationDecorator):
            yield method
...
class ControllerDecorator:
    ...
    def add_route(self, cls_route_function: "OperationDecorator") -> None:
