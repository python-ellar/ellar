...
if t.TYPE_CHECKING:
    ...
    from architek.route_models import WebsocketParameterModel
...
class WebSocketExtraHandler:
    def __init__(
        ...
        *,
        route_parameter_model: "WebsocketParameterModel",
        ...
        self.route_parameter_model: "WebsocketParameterModel" = route_parameter_model
