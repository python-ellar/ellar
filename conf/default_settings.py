...
from starletteapi.responses import PlainTextResponse
from starletteapi.exceptions import RequestValidationError, APIException, StarletteHTTPException
...
DEFAULT_NOT_FOUND_HANDLER: t.Callable[[TScope, TReceive, TSend], t.Coroutine[t.Any, t.Any, None]] = _not_found
# The lifespan context function is a newer style that replaces
# on_startup / on_shutdown handlers. Use one or the other, not both.
DEFAULT_LIFESPAN_HANDLER: t.Optional[t.Callable[["StarletteApp"], t.AsyncContextManager]] = None
